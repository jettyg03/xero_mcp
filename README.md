...
- **[docs/XERO_OFFICIAL_MCP_COMPANION.md](./docs/XERO_OFFICIAL_MCP_COMPANION.md)** — Hybrid setup: run the official Xero MCP server alongside `ingest_xero_data` (BEN-43).
