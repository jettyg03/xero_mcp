...
interface PipelineContext {
  ...
  clientProfile?:             ClientRDProfile;         // Stage 1 (CoWork extraction)
  transactions?:              NormalisedTransaction[]; // Stage 2
  vendorProfiles?:            Map<string, VendorProfile>; // Stage 3
  categorisedTransactions?:   CategorisedTransaction[]; // Stage 4
  financialSummary?:          FinancialSummary;        // Stage 5
  submissionDocument?:        SubmissionDocument;      // Stage 6
